...
def test_record_offline():
    ...
    p = utils.decode_miio_offline(raw)
...
def test_gw_heartbeat():
    ...
    p = utils.decode_miio_json(raw, b"event.gw.heartbeat")
...
def test_properties_changed():
    ...
    p = utils.decode_miio_json(raw, b"properties_changed")
...
def test_ble_event():
    ...
    p = utils.decode_miio_json(raw, b"_async.ble_event")
