...
OPENMIIO_URL_MIPS = f"{OPENMIIO_BASE}openmiio_agent_mips"
OPENMIIO_URL_ARM = f"{OPENMIIO_BASE}openmiio_agent_arm"
...
class ShellOpenMiio(TelnetShell):
    ...
    async def check_openmiio(self) -> bool:
        ...
        cmd = "[ -x /data/openmiio_agent ] && md5sum /data/openmiio_agent"
