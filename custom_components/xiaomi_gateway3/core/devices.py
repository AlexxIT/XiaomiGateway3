...
=======
>>>>>>> 6cdb3a7 (Add the support of Aqara Gateways)
}, {
...
DEVICES_AIOT_GATEWAY = [{
    ...
    "spec": [
        ...
        MapConv("alarm_bell_index", "select", mi="14.1.85", map=ALARM_INDEX_MAP, entity={"icon": "mdi:alarm-panel"}),
        BoolConv("alarm_status", "button", mi="14.1.111", entity={"icon": "mdi:alarm"}),
        MathConv("alarm_volume", "number", mi="14.1.1000", min=0, max=100, entity={"icon": "mdi:volume-medium", "mode": "slider"}),  # config
        MathConv("system_volume", "number", mi="14.11.85", min=0, max=100, entity={"icon": "mdi:volume-medium", "mode": "slider"}),  # config
        MapConv("alarm", "alarm_control_panel", mi="8.0.2242", map={0: "disarmed", 1: "armed_home", 2: "armed_away", 3: "armed_night"}),
        #MapConv("arming_status", "select", mi="14.6.111", map={0: "disarmed", 1: "armed", 2: "arming", 3: "toggle", 4: "enabled"}),
    ],
}, {
    ...
    "spec": [
        ...
        MathConv("system_volume", "number", mi="14.11.85", min=0, max=100, entity={"icon": "mdi:volume-medium", "mode": "slider"}),  # config
        MapConv("led_dnd", "switch", mi="14.21.85", map={5162040: True, 5162041: False}, entity=ENTITY_CONFIG),
        MapConv("alarm", "alarm_control_panel", mi="8.0.2242", map={0: "armed_home", 1: "armed_away", 2: "armed_night", 3: "disarmed"}),
        #BoolConv("alarm_trigger", "switch", mi="14.6.111"),
    ...
    "spec": [
        ...
        ZTransitionConv("transition"),
        RGBColor("rgb_color", mi="14.7.85"),
        MathConv("doorbell_volume", "number", mi="14.2.1000", min=0, max=100, entity={"icon": "mdi:volume-source", "mode": "slider"}),  # config
        MapConv("language", "select", mi="14.10.85", map={1: "Chinese", 2: "English"}),
...
#        BaseConv("rtsp_url", "sensor", mi="13.168.85", entity={"icon": "mdi:webcam"}),
        ...
        BoolConv("alarm_status", "button", mi="14.1.111", entity={"icon": "mdi:alarm"}),
        MathConv("alarm_volume", "number", mi="14.1.1000", min=0, max=100, entity={"icon": "mdi:volume-medium", "mode": "slider"}),  # config
        BoolConv("timestamp_watermark", "switch", mi="14.4.85", entity={"icon": "mdi:clipboard-text-clock"}),
        MathConv("system_volume", "number", mi="14.11.85", min=0, max=100, entity={"icon": "mdi:volume-medium", "mode": "slider"}),  # config
        MapConv("language", "select", mi="14.10.85", map={1: "Chinese", 2: "English"}),
        ...
        BoolConv("active_video", "switch", mi="14.74.85", entity={"icon": "mdi:cctv"}),
        ...
        MapConv("ac_frequency", "select", mi="14.120.85", map={1: "60Hz", 0: "50Hz"}),
...
#        BoolConv("pets_sound", "switch", mi="14.175.85", entity={"icon": "mdi:paw"}),
    ...
    "spec": [
        ...
        BoolConv("camera_timelapse", "switch", mi="4.27.85", entity={"icon": "mdi:timelapse"}),
        BoolConv("camera_timelapse_push", "switch", mi="4.28.85", entity={"icon": "mdi:timelapse"}),
#        BoolConv("logo_watermark", "switch", mi="4.60.85", entity={"icon": "mdi:watermark"}),
        BoolConv("block_sound", "switch", mi="4.63.85", entity={"icon": "mdi:speaker-off"}),
...
#        MathConv("music_volume", "number", mi="14.3.1000", min=0, max=100, entity={"icon": "mdi:volume-medium"}),  # config
        ...
        MathConv("system_volume", "number", mi="14.11.85", min=0, max=100, entity={"icon": "mdi:volume-medium", "mode": "slider"}),  # config
        MapConv("led_dnd", "switch", mi="14.21.85", map={5162040: True, 5162041: False}, entity=ENTITY_CONFIG),
        BoolConv("motion_record", "switch", mi="14.50.85", entity={"icon": "mdi:motion-sensor"}),
        BoolConv("motion_push", "switch", mi="14.51.85", entity={"icon": "mdi:motion-sensor"}),
        BoolConv("sound_record", "switch", mi="14.52.85", entity={"icon": "mdi:speaker-wireless"}),
        BoolConv("sound_push", "switch", mi="14.53.85", entity={"icon": "mdi:speaker-wireless"}),
#        MathConv("camera_volume", "number", mi="14.65.85", min=0, max=100, entity={"icon": "mdi:volume-medium"}),  # config
        MapConv("image_flip", "select", mi="14.68.85", map={0: "Normal", 1: "Horizontal", 2: "Vertical", 3: "Both"}),  # config
        BoolConv("motion_detect", "switch", mi="14.70.85", entity={"icon": "mdi:motion-sensor"}),
        MapConv("infrared_led", "select", mi="14.73.85", map={0: "Off", 1: "On", 2: "Auto"}),
        BoolConv("sound_trigger", "switch", mi="14.119.85", entity={"icon": "mdi:speaker-wireless"}),
        MapConv("ac_frequency", "select", mi="14.120.85", map={1: "60Hz", 0: "50Hz"}),
        BoolConv("sleep", "switch", mi="14.125.85", entity={"icon": "mdi:sleep"}),
        BoolConv("ark_mode_2", "switch", mi="8.0.2327", entity={"icon": "mdi:ferry"}),
    ],
}, {
    ...
    "spec": [
        ...
        #BaseConv("sdcard_info", "sensor", mi="13.25.85")
        BoolConv("high_temp_alarm", "switch", mi="4.67.85", entity={"icon": "mdi:doorbell-video"}),
        BoolConv("low_temp_alarm", "switch", mi="4.68.85", entity={"icon": "mdi:doorbell-video"}),
        BaseConv("bell_ring", "sensor", mi="13.12.85", entity={"icon": "mdi:doorbell-video"}),
        BaseConv("detect_face", "sensor", mi="13.95.85", entity={"icon": "mdi:face-recognition"}),
        BaseConv("detect_human", "sensor", mi="13.97.85", entity={"icon": "mdi:motion-outline"}),
#        BaseConv("rtsp_url", "sensor", mi="13.168.85", entity={"icon": "mdi:webcam"}),
        BoolConv("alarm_status", "button", mi="14.1.111", entity={"icon": "mdi:alarm"}),
        MathConv("alarm_bell_volume", "number", mi="14.1.1000", min=0, max=100, entity={"icon": "mdi:volume-medium", "mode": "slider"}),  # config
        BoolConv("control_camera", "switch", mi="14.8.85", entity={"icon": "mdi:cctv"}),
        MathConv("system_volume", "number", mi="14.11.85", min=0, max=100, entity={"icon": "mdi:volume-medium", "mode": "slider"}),  # config
        MathConv("camera_volume", "number", mi="14.65.85", min=0, max=100, entity={"icon": "mdi:volume-medium", "mode": "slider"}),  # config
        MapConv("language", "select", mi="14.10.85", map={1: "Chinese", 2: "English"}),
        BoolConv("damage_alarm", "switch", mi="14.66.85", entity={"icon": "mdi:doorbell"}),
        MapConv("image_flip", "select", mi="14.68.85", map={0: "Normal", 1: "horizontal", 2: "vertical", 3: "both"}, entity={"icon": "mdi:doorbell-video"}),  # config
        BoolConv("motion_detect", "switch", mi="14.70.85", entity={"icon": "mdi:motion-sensor"}),
        BoolConv("face_detect", "switch", mi="14.75.85", entity={"icon": "mdi:face-recognition"}),
        BoolConv("human_detect", "switch", mi="14.77.85", entity={"icon": "mdi:motion-outline"}),
        MapConv("ac_frequency", "select", mi="14.120.85", map={1: "60Hz", 0: "50Hz"}),
...
#        BaseConv("air_quality_index", "air_quality", mi="13.1.85", entity={"icon": "mdi:air-filter"}),
    ...
    "spec": [
        ...
        MathConv("humidity", "sensor", mi="0.2.85", multiply=0.01, min=0, max=10000),
        BaseConv("illuminance", "sensor", mi="0.3.85"),
        # MathConv("range", "number", mi="1.1.85", min=0, max=6),  # config
        # MathConv("unman_delay", "number", mi="1.161.85", min=0, max=300),  # config
        MathConv("pir_detect_interval", "number", mi="1.22.85", min=2, max=300, entity=ENTITY_CONFIG),
        # ConstConv("motion", "binary_sensor", mi="3.2.85", value=True),
        BoolConv("motion", "binary_sensor", mi="3.2.85"),
        # MapConv("people_active_status", "sensor", mi="13.1.85", map={2: "No People", 3: "People Moving", 4: "All Still"}),
        BoolConv("occupancy", "binary_sensor", mi="3.51.85"),
        # BoolConv("radar", "switch", mi="4.3.85"),
        MapConv("sensitivity", "select", mi="14.1.85", map={1: "low", 2: "medium", 3: "high"}, entity=ENTITY_CONFIG),  # config
        MapConv("temperature_report_mode", "select", mi="14.104.85", map={1: "threshold", 2: "interval", 3: "Both"}, entity=ENTITY_CONFIG),  # config
        MapConv("humidity_report_mode", "select", mi="14.105.85", map={1: "threshold", 2: "interval", 3: "Both"}, entity=ENTITY_CONFIG),  # config
        MapConv("light_report_mode", "select", mi="14.106.85", map={1: "threshold", 2: "interval", 3: "Both"}, entity=ENTITY_CONFIG),  # config
        MapConv("adaptive_switch", "select", mi="4.4.85", map={0: "Disable", 1: "Enable"}, entity={"name": "AI sensitivity adaptive switch", "category": "config", "enabled": False}),  # config
        MapConv("light_detect", "select", mi="14.28.85", map={0: "Disable", 1: "Low", 2: "Middle", 3: "High", 4: "Custom"}, entity=ENTITY_CONFIG),  # config
        MapConv("env_detect", "select", mi="14.120.85", map={0: "Disable", 1: "Low", 2: "Middle", 3: "High", 4: "Custom"}, entity=ENTITY_CONFIG),  # config
        MapConv("working_mode", "select", mi="14.59.85", map={0: "Both", 1: "Radar", 2: "PIR"}, entity=ENTITY_CONFIG),  # config
        MapConv("recognition_switch", "select", mi="4.72.85", map={0: "Disable", 1: "Enable"}, entity={"name": "AI interference comes from recognition switch", "category": "config", "enabled": False}),  # config
        BaseConv("battery_original", mi="8.0.2001"),  # diagnostic
        BaseConv("battery_voltage", "sensor", mi="8.0.2008"),  # diagnostic
        BoolConv("light_pollution", "switch", mi="8.0.2032", entity=ENTITY_CONFIG),  # config
    ],
    "ttl": "0s",
}, {
